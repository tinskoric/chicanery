...
ggsave(tile_bg, filename = "data/map/tilemap.png")
...
ggsave(province_bg, filename = "data/map/provincemap.png")
...
#ggsave(region_bg, filename = "data/map/regionmap.png", width = 6, height = 6, units = "in", dpi = 1024)
